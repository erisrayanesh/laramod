...
namespace ErisRayanesh\Laramod\Commands;

use ErisRayanesh\Laramod\Support\ModuleCommandHelper;
...
class PivotMigrationMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-pivot-migration';
    ...
    {
        return $this->getModule()->getPath('/database/migrations/' . date('Y_m_d_His') .
